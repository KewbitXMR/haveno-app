...
class ActiveTradeDetailScreen extends StatefulWidget {
  ...
  const ActiveTradeDetailScreen({required this.trade});

  @override
  _ActiveTradeDetailScreenState createState() =>
      _ActiveTradeDetailScreenState();
}

class _ActiveTradeDetailScreenState extends State<ActiveTradeDetailScreen> {
